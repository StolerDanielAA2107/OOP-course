...
// LR3_Stoler.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CLR3StolerApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CLR3StolerApp::OnAppAbout)
...
// Создание CLR3StolerApp

CLR3StolerApp::CLR3StolerApp() noexcept
{
	...
	SetAppID(_T("LR3Stoler.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CLR3StolerApp

CLR3StolerApp theApp;


// Инициализация CLR3StolerApp

BOOL CLR3StolerApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CLR3StolerDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CLR3StolerView));
	if (!pDocTemplate)
		return FALSE;
...
// Обработчики сообщений CLR3StolerApp
